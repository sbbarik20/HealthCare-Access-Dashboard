        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur"
          ...
          <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
              ...
              <h6 class="font-weight-bolder text-white mb-0">User's Table</h6>
            </nav>
              ...
              <div class="card mb-4">
                ...
                <div class="card-body px-0 pt-0 pb-2">
                  <div class="table-responsive p-0">
                    <table class="table align-items-center mb-0" id="dataTable" style="margin-left: 350px; width: 80%;" >
                      <thead>
                        <tr>
                      ...
                      <tbody>
                        <c:forEach var="user" items="${userd}">
                          <tr>
                            <td>
                              <label class="s" id="lblsl_no">${user.sl_no}</label>
                            </td>

                            <td>
                            <td>
                              <label class="s" id="lblname">${user.name}</label>
                              <input class="h" type="text" id="txtname" value="${user.name}">
                            </td>

                            <td>
                              <label class="s" id="lblemail">${user.email}</label>
                              <input class="h" type="text" id="txtemail" value="${user.email}">
                            </td>

                            <td>
                              <label class="s" id="lblrole">${user.role}</label>
                            </td>

                            <td>
                              <label class="s" id="lblstatus">${user.status}</label>
                              <input class="h" type="text" id="txtstatus" value="${user.status}">
                            </td>
                            <td>
