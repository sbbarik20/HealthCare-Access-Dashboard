                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                                <li class="breadcrumb-item text-sm"><a class="opacity-5 text-white"
                                        href="javascript:;">Doctor's</a></li>
                                <li class="breadcrumb-item text-sm text-white active" aria-current="page">Tables</li>
                            </ol>
                            <h6 class="font-weight-bolder text-white mb-0">Pending Appointment's Table</h6>
                        </nav>
                        ...
                        <div class="col-12">
                            <div class="card mb-4">
                                <div class="card-header pb-0">
                                    <h6>Pending Appointment's table</h6>
                                </div>
                                <div class="card-body px-0 pt-0 pb-2">
                                    <div class="table-responsive p-0">
                                        <table class="table align-items-center mb-0" id="dataTable">
                                            ...
                                            <tbody>
                                                <c:forEach var="pending_appointment" items="${pending_appointmentd}">
                                                    <tr>
                                                        <td id="sl_no">${pending_appointment.sl_no}</td>
                                                        <td>${pending_appointment.dr_name}</td>
                                                        <td>${pending_appointment.specialist}</td>
                                                        <td>${pending_appointment.pt_name}</td>
                                                        <td>${pending_appointment.pt_phone}</td>
                                                        <td>${pending_appointment.pt_email}</td>
                                                        <td>${pending_appointment.apt_date}</td>
                                                        <td>${pending_appointment.status}</td>
                                                        <td>
                                                            <input type="button" class="btn btn-outline-primary" value="Approve"></button>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
            ...
            <script>
                document.getElementById('searchInput').addEventListener('input', function () {
                    ...
                    for (let i = 1; i < rows.length; i++) {  // Start from 1 to skip header row
                        ...
                        if (dr_name.includes(searchValue) || specialist.includes(searchValue) || pt_name.includes(searchValue) || pt_phone.includes(searchValue) || pt_email.includes(searchValue) || status.includes(searchValue)) {
