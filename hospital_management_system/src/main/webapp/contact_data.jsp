        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur"
          ...
          <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
              ...
              <h6 class="font-weight-bolder text-white mb-0">Messages Table</h6>
            </nav>
                ...
                <div class="card-body px-0 pt-0 pb-2">
                  <div class="table-responsive p-0">
                    <table class="table align-items-center mb-0" id="dataTable">
                      ...
                      <tbody>
                        <c:forEach var="contact" items="${contactd}">
                          <tr>
                            <td>${contact.sl_no}</td>
                                <td>${contact.msg}</td>
                                <td>${contact.name}</td>
      ...
      <script>
        document.getElementById('searchInput').addEventListener('input', function () {
            ...
            for (let i = 1; i < rows.length; i++) {  // Start from 1 to skip header row
                ...
                let msg = rows[i].getElementsByTagName('td')[1].textContent.toLowerCase();
                ...
                let subject = rows[i].getElementsByTagName('td')[4].textContent.toLowerCase();
                
                

                if (msg.includes(searchValue) || name.includes(searchValue) || email.includes(searchValue) || subject.includes(searchValue)) {
